...
public class Request implements HttpExternalRequest {
    ...
    private org.dochi.inputbuffer.internal.Request request;
    ...
    // 각 AbstractProcessor 자식 객체 마다 InternalAdapter 객체를 주입 (InternalAdapter instance created per client)
    // Adapter에서 Connector.createRequest() 호출해서 connector.Request 생성
    // HttpXXProcesor.service(internal.Request/Response)
    // -> InternalAdapter.service(internal.Request/Response)
    // -> internal.Request를 setRequest 메서드를 통해 주입하고 InternalAdapter 객체의 필드에 connector.Request 저장 (connector.Request == null이면, 생성)
    ...
    public void setInternalRequest(org.dochi.inputbuffer.internal.Request request) {
