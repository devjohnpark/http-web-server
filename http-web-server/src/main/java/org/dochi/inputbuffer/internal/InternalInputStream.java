...
//
//public class InternalInputStream extends BufferedSocketInputStream implements Closeable {
//    private final static int DEFAULT_BUFFER_SIZE = 8192;
//    private final ByteBuffer inputStreamBuffer;
//    private final InputBuffer inputBuffer;
//    private ByteBuffer sourceBuffer;
//    private boolean isClosed;
//    private boolean isInputStreamBuffer;
//
...
//        this.inputStreamBuffer.flip();
//        this.sourceBuffer = inputBuffer.getBuffer();
//        this.isClosed = false;
...
//        if (!isInputStreamBuffer && !inputBuffer.getBuffer().hasRemaining()) {
...
//    // 내부 버퍼의 종류는 InputBuffer/BufferedSocketInputStream 버퍼가 있다.
//
//    @Override
...
////    public int read() throws IOException {
////        throwIfClosed();
////        if (!this.inputStreamBuffer.hasRemaining() && fill() < 0) {
////            return -1;
////        }
////        return inputStreamBuffer.get() & 0xFF;
////    }
//
//    @Override
...
//            return 0;
//        }
//        shouldInputStreamBuffer(); // BufferedSocketInputStream/InputBuffer 중에서 버퍼 변경 필요하면 변경
//        int fillCnt = 0;
...
////        ByteBuffer byteBuffer = ByteBuffer.wrap(b, off, len);
////        byteBuffer.flip();
////        return inputBuffer.doRead(byteBuffer);
////    }
//
//
