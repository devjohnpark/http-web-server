...
//
//    protected final org.dochi.internal.Request request;
...
//        this.request = new org.dochi.internal.Request();
...
////                new BufferedRequestStream(BufferedSocketInputStream requestStream) {
...
////            public BufferedRequestStream(BufferedSocketInputStream requestStream) {
...
////        class BufferedRequestStream extends BufferedSocketInputStream {
////            public BufferedRequestStream(BufferedSocketInputStream requestStream) {
////                super(requestStream.getInputStream());
////                count = requestStream.copyBuffer(buf);
////            }
...
////    }
//
////    public BufferedSocketInputStream getInputStream() { return requestStream.getRequestStream(); }
//
//    public HttpMethod getMethod() { return request; }
//
