...
//// HttpRequestProcessor 구현체에서는 RequestMetadata, MimeHeaders, RequestParameters 참조하고 있어서 필요없음
//// HttpRequestProcessor 구현체에서 RequestMetadata, MimeHeaders, RequestParameters 객체를 HttpApiRequest 구현체에 넘길수도 있음
