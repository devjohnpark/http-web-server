...
// 반면에 InternalInputStream은 java의 여타 InputStream 상속 클래스 처럼 한번 생성되고 소모되는 객체이다.
...
// 동시성 기능이 없기 때문에 BufferedInputStream 보다 읽기 속도가 더 빠르다.
public class InputBuffer implements ApplicationBufferHandler, Closeable {
    ...
    public void setRequest(Request internalRequest) {
